...
type TestService interface {
	CallNative(ctx context.Context, req *Request, opts ...client.CallOption) (*Response, error)
	CallMicro(ctx context.Context, req *Request, opts ...client.CallOption) (*Response, error)
...
func (c *testService) CallNative(ctx context.Context, req *Request, opts ...client.CallOption) (*Response, error) {
	rsp := &Response{}
	err := c.c.Call(ctx, c.c.NewRequest(c.name, "Test.CallNative", req), rsp, opts...)
	if err != nil {
		return nil, err
	}
	return rsp, nil
...
func (c *testService) CallMicro(ctx context.Context, req *Request, opts ...client.CallOption) (*Response, error) {
	rsp := &Response{}
	err := c.c.Call(ctx, c.c.NewRequest(c.name, "Test.CallMicro", req), rsp, opts...)
	if err != nil {
		return nil, err
	}
	return rsp, nil
...
func RegisterTestHandler(s server.Server, hdlr TestHandler, opts ...server.HandlerOption) error {
	type test interface {
		CallNative(ctx context.Context, req *Request, rsp *Response) error
		CallMicro(ctx context.Context, req *Request, rsp *Response) error
...
func (h *testHandler) CallNative(ctx context.Context, req *Request, rsp *Response) error {
	return h.TestHandler.CallNative(ctx, req, rsp)
}

func (h *testHandler) CallMicro(ctx context.Context, req *Request, rsp *Response) error {
	return h.TestHandler.CallMicro(ctx, req, rsp)
}
